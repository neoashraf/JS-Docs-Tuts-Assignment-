...
//names = names.filter(function(name){return name!=='John'}).map(function(name){ return {name:name} }).sort(function(obj1,obj2){ return obj1.name>obj2.name});
//console.log(names);
//var justAnArray = []
//justAnArray[100]=100;
...
//passing arguments===========================================================================
//var letsCheck = {name:'isReference'}; //for objects it's passing the reference
//function passingObject(obj){
//    obj.name = 'isReferenceTrue';
//    obj={name:'differentReference'};
//}
...
//
//var module = (function () {
//    var publicObject = {},privateVariable = 1;
//
